...
class AppStyles {
  ...
  static TextStyle bold16Black = GoogleFonts.elMessiri(
      fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.blackColor1);
  static TextStyle bold20Black = GoogleFonts.elMessiri(
      fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.blackColor1);
  static TextStyle bold24Black = GoogleFonts.elMessiri(
      fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.blackColor1);
  static TextStyle bold14Black = GoogleFonts.elMessiri(
      fontSize: 14, fontWeight: FontWeight.bold, color: AppColors.blackColor1);
